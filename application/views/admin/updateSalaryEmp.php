        ...
        <div class="main">
            ...
            <div class="contents">
                ...
                <div style="margin:20px 0px;text-align:right;">
                    <a href="<?php echo BASEURL.'/salary'?>" class="button_link">Back to List</a>
                </div>
                ...
                <div class="frm-add">
                    ...
                    <form name="frmAdd" action="<?php echo BASEURL.'/salary/update'?>" method="POST">
                        ...
                        <div class="demo-form-row">
                            ...
                            <input type="text" name="salary" class="demo-form-field" value="<?php echo $result[0]['salary']; ?>" readonly />
                        </div>

                        <div class="demo-form-row">
                            <label>New Salary: </label><br>
                            <input type="text" name="new_salary" class="demo-form-field" required />
                        </div>
